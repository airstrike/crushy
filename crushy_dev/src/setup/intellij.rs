...
// This allows IntelliJ to analyze rustc internals and show proper information inside Crushy
...
const CRUSHY_PROJECTS: &[CrushyProjectInfo] = &[
    CrushyProjectInfo::new("root", "Cargo.toml", "src/driver.rs"),
    CrushyProjectInfo::new("crushy_lints", "crushy_lints/Cargo.toml", "crushy_lints/src/lib.rs"),
    CrushyProjectInfo::new("crushy_utils", "crushy_utils/Cargo.toml", "crushy_utils/src/lib.rs"),
];

/// Used to store clippy project information to later inject the dependency into.
struct CrushyProjectInfo {
...
pub fn setup_rustc_src(rustc_path: &str) {
    ...
    for project in CRUSHY_PROJECTS {
...
fn inject_deps_into_project(rustc_source_dir: &Path, project: &CrushyProjectInfo) -> Result<(), ()> {
...
/// `crushy_dev` expects to be executed in the root directory of Crushy. This function
...
fn remove_rustc_src_from_project(project: &CrushyProjectInfo) -> bool {
