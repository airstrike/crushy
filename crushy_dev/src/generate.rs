...
impl LintData<'_> {
    pub fn gen_decls(&self, update_mode: UpdateMode) {
        ...
        updater.update_file_checked(
            "cargo dev update_lints",
            update_mode,
            "crushy_lints/src/deprecated_lints.rs",
            &mut |_, src, dst| {
        ...
        updater.update_file_checked(
            ...
            &mut |_, src, dst| {
                ...
                for &(lint, _) in &deprecated {
                    writeln!(dst, "#![warn(crushy::{lint})] //~ ERROR: lint `crushy::{lint}`").unwrap();
                }
                dst.push_str("\nfn main() {}\n");
                UpdateStatus::from_changed(src != dst)
            },
        ...
        updater.update_file_checked(
            ...
            &mut move |_, src, dst| {
                ...
                dst.push_str(GENERATED_FILE_COMMENT);
                dst.push_str("#![allow(crushy::duplicated_attributes)]\n");
        ...
        for (crate_name, lints) in active.iter().copied().into_group_map_by(|&(_, lint)| {
            ...
            updater.update_file_checked(
                ...
                &mut |_, src, dst| {
                    dst.push_str(GENERATED_FILE_COMMENT);
                    dst.push_str("pub static LINTS: &[&::declare_crushy_lint::LintInfo] = &[\n");
