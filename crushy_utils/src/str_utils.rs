...
///
/// ```no_run
/// # use crushy_utils::str_utils::{camel_case_until, StrIndex};
...
///
/// ```no_run
/// # use crushy_utils::str_utils::{camel_case_start, StrIndex};
...
///
/// ```no_run
/// # use crushy_utils::str_utils::{camel_case_start_from_idx, StrIndex};
...
///
/// ```no_run
/// # use crushy_utils::str_utils::{camel_case_indices, StrIndex};
/// assert_eq!(
...
///
/// ```no_run
/// # use crushy_utils::str_utils::{camel_case_split, StrIndex};
...
///
/// ```no_run
/// # use crushy_utils::str_utils::{count_match_start, StrCount};
...
///
/// ```no_run
/// # use crushy_utils::str_utils::{count_match_end, StrCount};
...
/// assert_eq!(count_match_end("Crushy", "Crushy"), StrCount::new(6, 6));
...
/// ```no_run
/// use crushy_utils::str_utils::to_snake_case;
...
/// ```no_run
/// use crushy_utils::str_utils::to_camel_case;
