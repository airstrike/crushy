//! This module contains paths to types and functions Crushy needs to know
//! about.
//!
...
impl PathLookup {
    /// Only exported for tests and `crushy_lints_internal`
    #[doc(hidden)]
...
// Paths for internal lints go in `crushy_lints_internal/src/internal_paths.rs`
